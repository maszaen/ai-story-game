  ...
  return (
    <div className="h-screen flex flex-col relative overflow-hidden"
      ...
      <div className="flex-shrink-0 flex flex-col items-center px-4 pt-4 relative z-10">
        ...
        <div className="text-center mb-3 md:mb-4">
          <div className="mb-2 md:mb-3">
            <span className="text-amber-700 text-xs md:text-sm tracking-[0.4em] uppercase" style={{ fontFamily: "'Cinzel', serif" }}>
              Pilih Perjalananmu
            </span>
          </div>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-wider mb-2"
            style={{
          ...
          <p className="text-amber-800/60 text-xs md:text-sm italic max-w-md mx-auto" style={{ fontFamily: "'Crimson Text', serif" }}>
      ...
      <div className="flex-1 overflow-y-auto relative px-4 pb-8" style={{ scrollbarWidth: 'thin', scrollbarColor: '#c9a84c33 transparent' }}>
        <div className="sticky top-0 left-0 right-0 h-6 pointer-events-none z-10 -mb-6" style={{
          background: 'linear-gradient(to bottom, rgba(13,7,4,1) 0%, rgba(13,7,4,0) 100%)',
        }} />
        <div className="w-full max-w-3xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-3 pt-2">
        {GENRES.map(genre => (
          <button
            key={genre.id}
